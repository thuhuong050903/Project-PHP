...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="margin-left:250px">
            <h2 style="margin-left: 400px; ">List Vehicles</h2>

            <button style="margin-left: 40px;"> <a href="../driver/addvehicles.php">ADD Vehicles</a></button>
            ...
            <div class="row" style="margin-left:30px">
                <table class='table' style='padding: 5px;'>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM vehicles  order by name_vehicles, vehicle_type, image , capacity, seat, description";
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Bạn có muốn sửa xe này không?');" href="../driver/editvehicles.php?edit=<?php echo $row['id_vehicle']; ?>">
                                        ...
                                        <a onclick="return confirm('Bạn có muốn xóa xe này không?');" href="../../assets/xulyxoaxe.php? delete=<?php echo $row['id_vehicle'] ?> & hinhanh=<?php echo $row['image'] ?>">
