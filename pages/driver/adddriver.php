          ...
          <form id="quickForm" method="post" action="../../assets/xulythemdrivers.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="namedriver" class="form-control" id="namedriver" placeholder="Enter name driver">
              </div>
              <div class="form-group">
                <label for="exampleInputdriver_license1">driver_license</label>
                <input type="text" name="driver_license" class="form-control" id="driver_license" placeholder="enter driver_license">
              </div>
              <div class="form-group">
