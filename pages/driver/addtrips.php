      ...
      <div class="col-md-12">
        <div class="card card-primary">
          ...
          <div class="form-group">
                    ...
                    <input type="text" name="point_of_departure" class="form-control" id="point_of_departure" placeholder="Enter point_of_departure">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="price_ship" class="form-control" id="price_ship" placeholder="enter price_ship">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputcapacity1">price_book</label>
                    <input type="number" name="price_book" class="form-control" id="price_book" placeholder="enter price_book">
                  </div>
                  <div class="form-group">
